...
Please see the man page for ime-ctl or the attached `developer guide document </docs/source/aux_pages/images/Delt_IME/IME1.4DeveloperGuide.pdf>`_ for details.
