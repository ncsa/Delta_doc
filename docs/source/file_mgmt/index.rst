...
There are some important caveats when using the /ime file system for something other than a **read-cache**. See section 2.2 Data Consistency Model in the `developer guide document <docs/source/aux_pages/images/Delt_IME/IME1_4DeveloperGuide.pdf>`_.
...
See the man page for ime-ctl or the attached `developer guide document <../aux_pages/images/Delt_IME/IME1_4DeveloperGuide.pdf>`_ for details.
