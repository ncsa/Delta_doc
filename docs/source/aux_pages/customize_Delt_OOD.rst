...
..  image:: images/customize_Delt_OOD/01_connect-to-jupyter.png
...
..  image:: images/customize_Delt_OOD/02_jupyter-mynewenv.png
...
..  image:: images/customize_Delt_OOD/03_mynewenv-kernel.png
    :alt: match kernel
    :width: 1000px
...
..  image:: images/customize_Delt_OOD/04_ood_launcher.png
    :alt: R launcher options
    :width: 1000px

Proceed to use R:

..  image:: images/customize_Delt_OOD/05_r_example.png
...
For internal staff debugging (also useful for new OOD users: )
