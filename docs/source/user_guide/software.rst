...
- `pip3 <https://docs.python.org/3/installing/index.html>`_: ``pip3 install --user <python_package>``  (installs to ``$HOME/.local/` unless you are using a venv or conda environment as above`)
