...
.. tabs::
  ...
  .. tab:: Slingshot 11
    ...
    .. table:: MPI Program Commands
       ...
       +------------------------------+--------------------------------------------+--------------------------------------+---------------+
       | MPI Implementation           | Module Files for                           | Build Commands                       | capabilities  |
       |                              | MPI/Compiler                               |                                      |               |
       +==============================+============================================+======================================+===============+
       |                              | .. code-block::                            |                                      |               |
       |                              |                                            |                                      |               |
       ...
       | - `Open MPI Home Page`_      | .. code-block::                            | |             |                   |  |               |
       | - `Open MPI Documentation`_  |                                            | +-------------+-------------------+  |               |
       |                              |    aocc/3.20 open                          | | Fortran 90: | mpif90 myprog.f90 |  |               |
       |                              |                                            | |             |                   |  |               |
       |                              | .. code-block::                            | |             |                   |  |               |
       |                              |                                            | +-------------+-------------------+  |               |
       |                              |    nvhpc/22.2 openmpi                      | | C:          | mpicc myprog.c    |  |               |
       |                              |                                            | |             |                   |  |  no           |
       |                              | .. code-block::                            | +-------------+-------------------+  |  GPU-direct   |
       |                              |                                            | | C++:        | mpic++ myprog.cc  |  |               |
       |                              |    intel-openapi-compilers/2022.02 openmpi | |             |                   |  |               |
       |                              |                                            | +-------------+-------------------+  |               |
       |                              |                                            |                                      |               |
       +------------------------------+--------------------------------------------+                                      |               |
       | Mvapich                      |  gcc/11.2.0 openmpi                        |                                      |               |
       +------------------------------+--------------------------------------------+                                      |               |
       | IntelMPI                     |  intel-openapi-compilers/2022.02  intelmpi |                                      |               |
       +------------------------------+--------------------------------------------+                                      |               |
       | Mvapich                      |                                            |                                      |               |
       +------------------------------+--------------------------------------------+                                      |               |
       | Mvapich                      |                                            |                                      |               |
       +------------------------------+--------------------------------------------+--------------------------------------+---------------+
       | Cray MPICH                   | craympich                                  |                                      |  has          |
       |                              | PrgEnv-gnu OR PrgEnv-nvidia OR PrgEnv-cray |                                      |  GPU-direct   |
       +------------------------------+--------------------------------------------+--------------------------------------+---------------+
